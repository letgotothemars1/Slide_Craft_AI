...
def build_presentation_prompt_parts(
    *,
    ...
    developer_instruction = (
        ...
        "20) For chart_focus slides: populate the 'chart' object with real numeric data — chart_type='bar' to "
        "compare across categories, 'line' for a trend over time, 'pie' for composition/share of a whole; provide "
        "3-6 'points' (label + numeric value); set 'unit' (e.g. '%', '₽', ' млн') or null. The action title states "
        "what the chart proves. Prefer chart_focus over kpi_cards when you have a SERIES of values, not isolated numbers. "
